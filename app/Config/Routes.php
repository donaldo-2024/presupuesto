...
$routes->get('rclientes', 'ReporteController::index');
$routes->get('rpresupuestos', 'ReporteController::presupuesto');
$routes->get('rmuebles', 'ReporteController::mueble');
$routes->get('rproductos', 'ReporteController::producto');
$routes->get('rproveedor', 'ReporteController::proveedor');